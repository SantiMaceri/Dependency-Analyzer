...
app.get('/create', (req, res) => {
    csvWriter
    .writeRecords(data)
    .then(()=> res.send('Welcome, csv created!'));
...
async function getContentLength(row, output){
...
addDependenciesFromHtml = (row, html, output) => {
    ...
    const dependencies = headTags.filter( tag => { return tag.name == "script" && isJs(tag.attribs.src)});
